...
Now that you&rsquo;ve seen dispersion happening in real life, try to recreate what you saw in a simulation.
...
The pink arrow coming off the object indicates a ray of light emitted from the object. When it hits the mirror, it is reflected, and this is the blue arrow. This beam is reflected into the viewer&rsquo;s eye.
...
The first selection shows the law of reflection, the second shows the object&rsquo;s and the image&rsquo;s distance from the mirror, and the final selection adds another green ray to the system.
...
:::
-->
<!--## PART 3: RAY TRACING FROM A PLANE MIRROR -->
