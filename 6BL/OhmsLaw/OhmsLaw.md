...
Please note that you will expected to turn in every plot and table you make for this lab, as well as justify your reasoning behind your answers.
...
:::GVideo 
13abGEHjGPAlNlA72gHoU2hptcdmXS3Zs
:::
...
This is what is stated in the introduction, and what you just saw in the simulations above. From this equation, it should be clear why the reciprocal of the slope of a plot of current vs. voltage is the resistance. Further algebraic rearrangement yields R directly (instead of its reciprocal):

$$R = V/I$$

::: Exercise
In Simulation 1 you will see a simple but effective demonstration of Ohm's Law. Use this simulation to gain understanding of Ohm's Law and how changing either the resistance of the resistor or the voltage across it changes the current. Notice that the size of each symbol changes to illustrate the change in magnitude of that value. In addition, the orange arrows on the the corners of the circuit change in size according to the magnitude of the current.

![Simulation 1](https://phet.colorado.edu/sims/html/ohms-law/latest/ohms-law_en.html){width=100% height=600px}

Using the equations above answer the following questions. 

::: Question
a) A $758\ \Omega$ resistor passes a current of 2.5 mA. What is the voltage across this resistor?

Use Simulation 1 to verify this result.
...
**Note:** Voltage is measured across circuit elements. Voltmeters are not part of the circuit loop, but must instead be placed in parallel with the element whose voltage you want to measure. 

<!-- Video 3: Voltage sweep -->

:::GVideo 
1nVjP41ZKt6C7EgT5SCn55EhqAzNzgAQp
:::

Video 3 shows the circuit from Figure 1 and Video 2 in which we change the voltage from the power supply from 0 volts to 20 volts.
...
2. Video 3 adjusts the voltage applied to the circuit using the power supply at the top. As the video scans through voltages you should pause it and record the voltage and corresponding current for 10 data points. You should take measurements approximately every 2 volts; however, it does not need to be exactly 2 volts, as long as the data points are fairly well spaced out. 
3. Neatly tabulate your data, then plot your data with current as the X-axis and voltage as your Y-axis.

::: Question
a) Is the plot linear or almost linear?
b) What is the value of the slope of this line? Use units. Note the equivalency volts/amperes = ohms.
...
In this exercise you use the technique from Exercise 2 to find the value of an unknown resistor. Video 4 will set up this circuit and scan through voltages. The circuit layout will be identical to Figure 1.

<!-- Video 4: Mystery Resistor -->

:::GVideo 
1Q75MGxrg3S-SQ_HeVW3edIktECPdj88C
:::
1. Video 4 adjusts the voltage applied to the circuit using the power supply at the top. As the video scans through voltages you should pause it and record the voltage and corresponding current for 10 data points. You should take measurements approximately every 2 volts; however, it does not need to be exactly 2 volts, as long as the data points are fairly well spaced out. 
2. Neatly tabulate your data, then plot your data with current as the X-axis and voltage as your Y-axis.
...
In a simple series circuit elements are connected end to end in a chain. *The current through each element is the same*. However, the total circuit voltage is divided among the individual elements. Individual series resistors combine to form a total resistance. Individual voltages in series circuits add to form the total circuit voltage. The entire source voltage will be dropped across the combination of two resistors. The voltage across each individual resistor is proportional to its individual resistance.
...
:::GVideo 
1Ul_S7augc2rNcOdlW4qVHDynu2bJ9RHe
:::

Video 5 will vary the voltage supplied to the circuit in Figure 2. 

**Note:** The voltmeter is placed across two resistors both of resistance $R$ chained end to end. The quantity measured by this device is the voltage across both resistors. The ammeter measures the amount of current flowing through the series circuit. 

2. Video 5 adjusts the voltage applied to the circuit using the power supply at the top. As the video scans through voltages you should pause it and record the voltage and corresponding current for 10 data points. You should take measurements approximately every 2 volts; however, it does not need to be exactly 2 volts, as long as the data points are fairly well spaced out. 
3. Neatly tabulate your data, then plot your data with current as the X-axis and voltage as your Y-axis.
...
:::GVideo 
1oZ8NXwqN_JdITnuXtNXGx_6Hy-Smr6IF
:::

Video 6 will vary the voltage supplied to the circuit in Figure 3. 

5. Video 6 adjusts the voltage applied to the circuit using the power supply at the top. As the video scans through voltages you should pause it and record the voltage and corresponding current for 10 data points. You should take measurements approximately every 2 volts; however, it does not need to be exactly 2 volts, as long as the data points are fairly well spaced out. 
6. Neatly tabulate your data, then plot your data with current as the X-axis and voltage as your Y-axis.
...
:::GVideo 
1L7qFZ-qIAhmla9i1eBBvtm_MUqHG8liZ
:::

Video 7 will vary the voltage supplied to the circuit in Figure 4. 

5. Video 7 adjusts the voltage applied to the circuit using the power supply at the top. As the video scans through voltages you should pause it and record the voltage and corresponding current for 10 data points. You should take measurements approximately every 2 volts; however, it does not need to be exactly 2 volts, as long as the data points are fairly well spaced out. 
6. Neatly tabulate your data, then plot your data with current as the X-axis and voltage as your Y-axis.

::: Question
a) How has the current changed roughly for each data point compared to your results in Exercise 2 and Question 5?
b) What is the resistance you measured from the slope of your plot? 
...
:::GVideo 
1mMkStu23L28fPTbcnl4XQlUa_WRk4IU_
:::
...
![Simulation 2](https://phet.colorado.edu/sims/html/circuit-construction-kit-dc-virtual-lab/latest/circuit-construction-kit-dc-virtual-lab_en.html){width=100% height=600px}
